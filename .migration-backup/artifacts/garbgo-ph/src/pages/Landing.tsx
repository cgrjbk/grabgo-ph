    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-20 pb-16 bg-gradient-to-br from-emerald-50 via-white to-emerald-50">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="mt-12 flex items-center justify-center gap-8 text-sm text-gray-500">
            <div className="flex items-center gap-2"><Clock className="w-5 h-5" /> Under 2 hours</div>
            <div className="flex items-center gap-2"><Shield className="w-5 h-5" /> Verified Collectors</div>
            <div className="flex items-center gap-2"><MapPin className="w-5 h-5" /> Zamboanga City Wide</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to keep Zamboanga clean?</h2>
